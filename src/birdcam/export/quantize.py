"""INT8 post-training quantisation with per-class delta.

NOT YET IMPLEMENTED -- scheduled for Phase 8.
...
def main() -> None:
    raise NotImplementedError(
        "birdcam.export.quantize is a Phase 8 deliverable and is not implemented yet."
    )
