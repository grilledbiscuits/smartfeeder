"""Knowledge distillation from teacher to CNN student.

NOT YET IMPLEMENTED -- scheduled for Phase 6.
...
def main() -> None:
    raise NotImplementedError(
        "birdcam.models.distill is a Phase 6 deliverable and is not implemented yet."
    )
