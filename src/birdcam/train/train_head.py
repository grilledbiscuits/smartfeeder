"""Fast loop: heads on cached features, target <10s/run.

NOT YET IMPLEMENTED -- scheduled for Phase 5.
...
def main() -> None:
    raise NotImplementedError(
        "birdcam.train.train_head is a Phase 5 deliverable and is not implemented yet."
    )
